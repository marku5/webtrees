				...
				<tr>
					<td class="descriptionbox">
						<?php if (Auth::isEditor($controller->record->getTree())) { ?>
							<a href="edit_interface.php?action=editnote&amp;ged=<?= $controller->record->getTree()->getNameHtml() ?>&amp;xref=<?= $controller->record->getXref() ?>" title="<?= I18N::translate('Edit') ?>">
							<i class="icon-note"></i> <?= I18N::translate('Shared note') ?>
							</a>
							<div class="editfacts">
								<div class="editlink">
								<a class="editicon" href="edit_interface.php?action=editnote&amp;ged=<?= $controller->record->getTree()->getNameHtml() ?>&amp;xref=<?= $controller->record->getXref() ?>" title="<?= I18N::translate('Edit') ?>">
